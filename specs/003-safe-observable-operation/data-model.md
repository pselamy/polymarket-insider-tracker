...
| `weighted_score` | NUMERIC(4, 3) | No | - | Calculated composite risk score (0.000 - 1.000) |
...
### 2.2 Ambiguity Temporary Key
- **Key Pattern**: `alert:ambiguous:{channel}:{wallet}:{market}`
- **Value**: ISO-8601 UTC timestamp of ambiguous send attempt.

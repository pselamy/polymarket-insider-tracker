...
- lock, Black format, Ruff lint, strict mypy, strict Pyright, Vulture dead-code check, and deterministic test gates all pass;
...
- Any Black, Ruff, mypy, Pyright, Vulture, pytest, service, or migration failure: aggregate exit is nonzero;

...
class TestMarketMetadataSync:
    ...
    def test_init_custom_config(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_stop(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_start_failure(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_market_cache_miss(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_market_not_found(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_invalidate_market(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_force_sync(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
        """Test forced sync."""
        sync = MarketMetadataSync(redis=mock_redis, clob_client=mock_clob, gamma_client=mock_gamma)
        await sync.start()
    ...
    @pytest.mark.asyncio
    async def test_state_change_callback(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    async def test_get_markets_by_category(
        self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock, sample_metadata: MarketMetadata
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_cannot_start_twice(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stop_when_stopped(self, mock_redis: AsyncMock, mock_clob: MagicMock, mock_gamma: MagicMock) -> None:
